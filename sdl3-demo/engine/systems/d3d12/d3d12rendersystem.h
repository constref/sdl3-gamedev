...
class D3D12RenderSystem : public System<FrameStage::Render, MeshComponent>, public Renderer
{
    ...
    D3D12_RESOURCE_STATES m_matrixBuffState =
        D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE | D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE;
    ComPtr<ID3D12Resource> m_objBuffer;
    D3D12_RESOURCE_STATES m_objBufferState =
        D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE | D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE;
    ...
    D3D12_RESOURCE_STATES m_lightsBufferState =
        D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE | D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE;
...
public:
    ...
    void scheduleAssetCopy(size_t stagingOffset, size_t dataSize, ComPtr<ID3D12Resource> dstBuffer,
